...
ERROR - 2018-01-11 15:06:25 --> Severity: Warning --> pg_query(): Query failed: ERROR:  relation &quot;qw.qw_prod_order_status2&quot; does not exist
...
ERROR - 2018-01-11 15:06:25 --> Query error: ERROR:  relation "qw.qw_prod_order_status2" does not exist
LINE 23:   FROM qw.qw_prod_order_status2 a
                ^
QUERY:  SELECT array_to_json(array_agg(row_to_json(so))) FROM (
  WITH diff AS ( SELECT DISTINCT a.salesorderno, TRUE AS whflag
...
CONTEXT:  PL/pgSQL function qw.get_all_orders_by_date(text,date,date,text,text,text,text) line 23 at RETURN - Invalid query: select * from qw.get_all_orders_by_date('All','2018-01-11','2018-01-11','All',
			'All','','All')
ERROR - 2018-01-11 19:41:19 --> Severity: Notice --> Undefined variable: division /var/www/html/application/views/frontend/index.php 759
ERROR - 2018-01-11 19:41:19 --> Severity: Notice --> Undefined variable: territory /var/www/html/application/views/frontend/index.php 770
