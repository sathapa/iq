        	...
        	<table width="100%" style="padding:0px 20px;" class="top-header">
            	<tr>
                	<td align="center" height="40">
						<strong style="">
							<?php
								$proposalNum	= !empty($quote_list->proposal_num) ? $quote_list->proposal_num : '';
								echo !empty($proposalNum) ? 'Proposal ID :'.$proposalNum :  'Proposal ID :'.$quote_id ;
							?>
						</strong>
					</td>
                </tr>
        ...
        <td height="0" style="background:#fff;" valign="top" >
        	<table width="100%" cellspacing="0" cellpadding="2" border="0" style="padding:0px 20px;" class="date-filde">
            	<tr>
                    ...
                    <td align="right" width="45%"><strong>Terms:</strong> <?=!empty($quote_list->termcode_desc)?$quote_list->termcode_desc:''?></td>
                </tr>
            </table>
        </td>
      </tr>
                   ...
                   <?=!empty($quote_list->contact_name)?'<p><strong>Name:</strong> '.$quote_list->contact_name.'</p>':''?>
                    ...
                    <td align="right" width="200"  valign="top">
                    	...
                    	<p>
							...
							?>
							<span><br><?=nl2br($quote_list->shipto_address)?><br></span>
							<?php } ?>
							<span><?=trim($f,',')?><br></span>
