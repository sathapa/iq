	...
	<div class="right-bar" id="page_layout">
		<div class="form-section">
			<div class="col-sm-12 top-head">
				<h1 id="quoting-heading">Survey</h1>
			</div>
			<div class="col-xs-8 inner-form" id="innerformdetails">
				<div><?php $message	= $this->session->flashdata('message'); echo $message;?></div>
				<div class="form-group form-wrap">
					<?php
						echo form_open('createSurvey', array('class'=>'form-row ','method'=>'POST','enctype'=>'multipart/form-data','id'=>'main_form','data-parsley-validate'=>'data-parsley-validate'));
					?>
						...
						<div class="panel-body">
							<div class="row">
								<div class="form-row half">
									...
									<div class="select1">
										<input type="text" name="customer" id="customer" Placeholder="Select Customer.." required>
									</div>
								</div>
								<div class="form-row half">
									<div class="form-row half">
										<label>Survey Date <em >*</em></label>
										   <div class='input-group date' id='datetimepicker1' >
													<input type='text' name="survey_date" class="form-control" placeholder="Survey Date" />
									...
									<!-- <div class="form-row half">
										...
										<div class="form-row half">
											<input type='text' name="no_items" class="form-control" data-parsley-type="digits" placeholder="No of items"/>
										</div>
									</div> -->
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="form-row half">
									...
									<textarea name="recommend" id="recommend" Placeholder="Recommendations" ></textarea>
								</div>
							</div>
...
<script>ClassicEditor.create( document.querySelector( '#summary' ) )</script>
<script>ClassicEditor.create( document.querySelector( '#recommend' ) )</script>
