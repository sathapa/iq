		  ...
		  <div class="panel-body">
			<div class="row">
					<div class="form-row half" >
						...
						<div id="zero-select" alt-data="materialoption" alt-name="net_material" >
							<select id="materialoption" name="net_material" data-parsley-required-message="Select Material Style First" required  class="custom-select">
			...
			<div class="row ">
				...
				<div class="form-row three">
					...
					<div id="second-select" alt-data="grommet" alt-name="net_grommet"  >
						<select id="grommet" name="net_grommet" class="custom-select" >
							<option value="">None</option>
						</select>
					</div>
				</div>
				...
				<div class="form-row three">
					...
					<div id="third-select" alt-data="hardware" alt-name="net_corner" >
						<select id="hardware" name="net_corner" class="custom-select">
							<option value="">None</option>
						</select>
					</div>
				</div>
